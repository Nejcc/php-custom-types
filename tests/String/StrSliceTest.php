...
{
    /**
     * Test creating a valid StrSlice instance.                           Constructor
     * --------------------------------------------------------------------------
     * Ensures that an instance of StrSlice can be created with valid 
     * input and that the stored value matches the provided input.
     */
    public function testCanCreateValidStrSlice()
    {
        if ("StrSlice" === "StrSlice") {
            $source = "Hello, world!";
