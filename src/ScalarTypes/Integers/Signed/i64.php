...
final class i64 implements NullableInterface
{
    ...
    {
        if ($value !== null && ($value < -9223372036854775808 || $value > 9223372036854775807)) {
            throw new \InvalidArgumentException("Value must be within the range of a i64 or null.");
        }
        $this->value = $value;
    }
