...
final class u128 implements NullableInterface
{
    ...
    {
        if ($value !== null && ($value < 0 || $value > 340282366920938463463374607431768211455)) {
            throw new \InvalidArgumentException("Value must be within the range of a u128 or null.");
        }
        $this->value = $value;
    }
