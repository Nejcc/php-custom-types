...
namespace Nejcc\CustomTypes\StringTypes;
...
final class OwnedString
{
    ...
    /**
     * Convert the owned string to a string representation.            ToString
     * --------------------------------------------------------------------------
     * Provides a string representation of the owned string, allowing
     * it to be easily output, logged, or used in concatenation with
     * other strings while maintaining dynamic mutability.
     */
