...
final class i128 implements NullableInterface
{
    ...
    {
        if ($value !== null && ($value < -170141183460469231731687303715884105728 || $value > 170141183460469231731687303715884105727)) {
            throw new \InvalidArgumentException("Value must be within the range of a i128 or null.");
        }
        $this->value = $value;
    }
